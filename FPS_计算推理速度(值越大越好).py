...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'C:\Users\Administrator\Desktop\yolov12new\yolov12new\ultralytics-fusion_v12mode1\ultralytics-fusion_v12mode1\ultralytics-fusion_v12\runs\yolov11-earlyfusion61\weights\best.pt', help='trained weights path')
